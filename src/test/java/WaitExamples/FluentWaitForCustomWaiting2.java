...
public class FluentWaitForCustomWaiting2 {
	...
	public static void main(String[] args) {
		...
		wait.until(new Function<ArrayList<String>, Boolean>() {
			...
			public Boolean apply(ArrayList<String> t) {
				...
				// You should notice that when it throws exception, remaining statement will be skipped and will start again after interval.
				try {
